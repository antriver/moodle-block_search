...
require_once __DIR__ . '/MoodleSearch/Data.php';
...
echo $searchBlock->getSearchBox($q, $courseID);
...
if (!empty($q)) {
	...
	require_once __DIR__ . '/MoodleSearch/Model/Result.php';
	require_once __DIR__ . '/MoodleSearch/Model/Search.php';
	$search = new MoodleSearch\Model\Search($q, $courseID);
